        ...
        <table className={styles.table}>
          ...
          <tbody className={styles.tbody}>
            <tr className={styles.tr}>
              ...
              <td className={styles.td}>ianrosales634@gmail.com</td>
              <td className={styles.td}>35</td>
              <td className={styles.td}>Administrador</td>
            ...
            <tr className={styles.tr}>
              ...
              <td className={styles.td}>gruejas@gmail.com</td>
              <td className={styles.td}>29</td>
              <td className={styles.td}>Editor</td>
              <td className={styles.td}>En Linea</td>
              <td className={styles.td}></td>
            </tr>
          </tbody>
