    ...
    <>
      ...
      >
        ...
        <div className={styles.main}>
          <Button href="/clients-area/profile" onClick={closeModal} className="navLeftButton" light>
            <UserRegularIcon width="16" height="16" />
            Perfil
          </Button>
          <Button href="/clients-area/notificatrions" onClick={closeModal} className="navLeftButton" light>
            <BellIcon width="16" height="16" />
            Notificaciones
          </Button>
          <Button href="/clients-area/account" onClick={closeModal} className="navLeftButton" light>
            <FileInvoiceIcon width="16" height="16" />
            Estado de Cuenta
          </Button>
          <Button href="/clients-area/charts" onClick={closeModal} className="navLeftButton" light>
            <ChartIcon width="16" height="16" />
            Estadisticas
          </Button>
          <Button href="/docs/admin" onClick={closeModal} className="navLeftButton" light>
